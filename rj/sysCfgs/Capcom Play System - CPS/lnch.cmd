...
:CPY
%XFG%attrib +h "fba*.ini"
%XFG%copy /Y "%GAMDIR%\.Mem\*.nv" "%EMUL%\config\games"
%XFG%copy /Y "%GAMDIR%\.sstates\*.fs" "%EMUL%\savestates"
%XFG%copy /Y "*.ini" "%EMUL%\config\games"
%XFG%attrib -h "fba*.ini"
%XFG%copy /Y "fba*.ini" "%EMUL%\config"
...
%LAUNCH% "%EMUL%\%EMUZ%.exe" %ROM%
%CCMDY%
%RLOC%popd
%XFG%copy /Y "%EMUL%\config\fba*.ini" "%GAMDIR%"
%XFG%move /Y "%EMUL%\config\games\*.ini" "%GAMDIR%"
%XFG%move /Y "%EMUL%\savestates\%ROM%*.fs" "%GAMDIR%\.sstates"
%XFG%move /Y "%EMUL%\config\games\%ROM%*.nv" "%GAMDIR%\.Mem"
%XFG%move /Y "%EMUL%\screenshots\*.png" "%GAMDIR%\.snaps"
